...
global $base_url;
  $variables = array(
    ...
    'create' => array('name'=>'<i class="icon-plus">&nbsp;</i> Create', 'path'=>'#', 'submenu'=>array(
      'idea' => array('name'=>csl('idea'), 'path'=> url('node/add/idea'),),
      'challenge' => array('name'=>csl('challenge',0,1), 'path'=>url('admin/structure/taxonomy/challenge/add'),),
    ...
    'edit' => array('name'=>'<i class="icon-setting-1">&nbsp;</i> Edit', 'path'=>'#', 'submenu'=>array(
      ...
      'featured-collaborations' => array('name'=>'Featured '. csl('collaborations',1,1), 'path'=>url('/admin/structure/nodequeue/1/view/1'),),
      'edit-challenges' => array('name'=>'Edit ' . csl('challenges',1,1), 'path'=>url('/admin/structure/taxonomy/challenge'),),
      'publish-challenges' => array('name'=>'Publish ' . csl('challenges',1,1), 'path'=>url('/admin/structure/term_queue/open_challenges'),),
    ),),
    ...
    'settings' => array('name'=>'<i class="icon-setting-2">&nbsp;</i> Settings', 'path'=>'#', 'submenu'=>array(
      ...
      'collaborations' => array('name'=>csl('collaborations',1,1), 'path'=>url('admin/config/collabco-settings/collaboration'),),
